\begin{code}%
\>\AgdaKeyword{module} \AgdaModule{agdARGS.Examples.WordCount} \AgdaKeyword{where}\<%
\\
%
\\
...
%
\\
\>\AgdaFunction{filePath} \AgdaSymbol{:} \AgdaPostulate{String} \AgdaSymbol{→} \AgdaFunction{Error} \AgdaPostulate{String} \<[33]%
\>[33]\<%
\\
\>\AgdaFunction{filePath} \AgdaSymbol{=} \AgdaInductiveConstructor{inj₂}\<%
\\
%
\\
...
%
\\
\>\AgdaFunction{FilePath} \AgdaSymbol{=} \AgdaPostulate{String}\<%
\\
%
\\
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaKeyword{let} \AgdaBound{keepLines} \AgdaSymbol{=} \AgdaFunction{is-just} \AgdaSymbol{(}\AgdaBound{mods} \AgdaFunction{‼} \AgdaString{"-l"}\AgdaSymbol{)} \AgdaFunction{∨} \AgdaFunction{is-nothing} \AgdaSymbol{(}\AgdaBound{mods} \AgdaFunction{‼} \AgdaString{"-w"}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaBound{keepWords} \AgdaSymbol{=} \AgdaFunction{is-just} \AgdaSymbol{(}\AgdaBound{mods} \AgdaFunction{‼} \AgdaString{"-w"}\AgdaSymbol{)} \AgdaFunction{∨} \AgdaFunction{is-nothing} \AgdaSymbol{(}\AgdaBound{mods} \AgdaFunction{‼} \AgdaString{"-l"}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{6}{}\<[6]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaCoinductiveConstructor{♯} \AgdaFunction{getArgs} \AgdaInductiveConstructor{>>=} \AgdaSymbol{λ} \AgdaBound{args} \AgdaSymbol{→}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{error} \AgdaSymbol{:} \AgdaPostulate{String} \AgdaSymbol{→} \AgdaDatatype{IO} \AgdaSymbol{\_}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{error} \AgdaSymbol{=} \AgdaFunction{putStrLn} \AgdaFunction{∘} \AgdaSymbol{(}\AgdaFunction{String.\_++\_} \AgdaString{"*** Error: "}\AgdaSymbol{)}\<%
\\
%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
...
\\
\>[4]\AgdaIndent{11}{}\<[11]%
\>[11]\AgdaFunction{if} \AgdaFunction{is-just} \AgdaSymbol{(}\AgdaBound{mods} \AgdaFunction{‼} \AgdaString{"--version"}\AgdaSymbol{)} \AgdaFunction{then} \AgdaFunction{putStrLn} \AgdaString{"WordCount: version 0.1"}\<%
\\
\>[0]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaFunction{else} \AgdaFunction{if} \AgdaFunction{is-just} \AgdaSymbol{(}\AgdaBound{mods} \AgdaFunction{‼} \AgdaString{"--help"}\AgdaSymbol{)} \<[43]%
\>[43]\AgdaFunction{then} \AgdaFunction{putStrLn} \AgdaString{"TODO: usage"}\<%
\\
\>[0]\AgdaIndent{6}{}\<[6]%
