\begin{code}%
\>\AgdaKeyword{module} \AgdaModule{agdARGS.Examples.Sum} \AgdaKeyword{where}\<%
\\
%
\\
...
\> \AgdaFunction{,} \<[4]%
\>[4]\AgdaFunction{<} \<[7]%
\>[7]\AgdaString{"nat"} \AgdaFunction{∷=} \AgdaFunction{basic} \AgdaSymbol{(}\AgdaFunction{lotsOf} \AgdaFunction{parseℕ}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{⟨} \<[7]%
\>[7]\AgdaString{"int"} \AgdaFunction{∷=} \AgdaFunction{basic} \AgdaSymbol{(}\AgdaFunction{lotsOf} \AgdaFunction{parseℤ}\AgdaSymbol{)} \AgdaFunction{⟨} \AgdaFunction{⟨⟩}\<%
\\
...
\\
\>\AgdaFunction{main} \AgdaSymbol{=} \AgdaFunction{run} \AgdaFunction{\$}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaCoinductiveConstructor{♯} \AgdaFunction{getArgs} \AgdaInductiveConstructor{IO.>>=} \AgdaSymbol{λ} \AgdaBound{args} \AgdaSymbol{→}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaCoinductiveConstructor{♯} \AgdaFunction{[} \AgdaFunction{error} \AgdaFunction{,} \AgdaFunction{success} \AgdaFunction{]′} \AgdaSymbol{(}\AgdaFunction{parseCommand} \AgdaSymbol{(}\AgdaField{exec} \AgdaFunction{cli}\AgdaSymbol{)} \AgdaBound{args}\AgdaSymbol{)}\<%
\\
%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{error} \AgdaSymbol{:} \AgdaPostulate{String} \AgdaSymbol{→} \AgdaSymbol{\_}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{error} \AgdaSymbol{=} \AgdaFunction{putStrLn} \AgdaFunction{∘} \AgdaFunction{String.\_++\_} \AgdaString{"*** Error: "}\<%
\\
%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{sumNat} \AgdaSymbol{=} \AgdaFunction{maybe} \AgdaSymbol{(}\AgdaFunction{foldr} \AgdaPrimitive{Nat.\_+\_} \AgdaNumber{0}\AgdaSymbol{)} \AgdaNumber{0}\<%
\\
%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
...
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{sumInt} \AgdaSymbol{=} \AgdaFunction{maybe} \AgdaSymbol{(}\AgdaFunction{foldr} \AgdaFunction{Int.\_+\_} \AgdaSymbol{(}\AgdaInductiveConstructor{+} \AgdaNumber{0}\AgdaSymbol{))} \AgdaSymbol{(}\AgdaInductiveConstructor{+} \AgdaNumber{0}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\<%
\\
...
\>[51]\AgdaSymbol{=} \AgdaFunction{putStrLn} \AgdaString{"meh"}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{success} \AgdaSymbol{(}\AgdaInductiveConstructor{[} \AgdaSymbol{.}\AgdaString{"int"} \AgdaInductiveConstructor{[} \<[26]%
\>[26]\AgdaInductiveConstructor{z} \AgdaInductiveConstructor{]∙} \AgdaSymbol{.}\AgdaString{"int"} \AgdaInductiveConstructor{∷=} \AgdaSymbol{\_} \AgdaInductiveConstructor{\&} \AgdaBound{vs} \AgdaInductiveConstructor{]}\AgdaSymbol{)} \AgdaSymbol{=} \AgdaFunction{putStrLn} \AgdaFunction{\$} \AgdaFunction{Int.show} \<[77]%
\>[77]\AgdaFunction{\$} \AgdaFunction{sumInt} \AgdaBound{vs}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{success} \AgdaSymbol{(}\AgdaInductiveConstructor{[} \AgdaSymbol{.}\AgdaString{"nat"} \AgdaInductiveConstructor{[} \AgdaInductiveConstructor{s} \AgdaInductiveConstructor{z} \AgdaInductiveConstructor{]∙} \AgdaSymbol{.}\AgdaString{"nat"} \AgdaInductiveConstructor{∷=} \AgdaSymbol{\_} \AgdaInductiveConstructor{\&} \AgdaBound{vs} \AgdaInductiveConstructor{]}\AgdaSymbol{)} \AgdaSymbol{=} \AgdaFunction{putStrLn} \AgdaFunction{\$} \AgdaFunction{NatShow.show} \AgdaFunction{\$} \AgdaFunction{sumNat} \AgdaBound{vs}\<%
\\
%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
